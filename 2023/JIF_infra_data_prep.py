# Data prep for infrastructure JIF plot
...
# JIF_merge_weISSN.to_excel("Check_me_manual_infrastructure_improve_Aug23.xlsx")
...
JIF_infra_data = JIF_merge_weISSN.groupby(["Year", "JIFcat"]).size().reset_index()
JIF_infra_data.columns = ["Year", "JIFcat", "Count"]

JIF_infra_data.to_excel("categorise_infrastructure_JIF_Aug23.xlsx")
