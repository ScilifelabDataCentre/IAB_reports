...
Fellows_data = Fellows_data[
    (Fellows_data["Publication_year"] > 2012)
    & (Fellows_data["Publication_year"] < 2023)
]
...
Fellows_data_sub = Fellows_data[
    [
        ...
        "citations_self_incl_2022.1",  # seems mislabelled.
    ]
]
...
Affiliates_data = Affiliates_data[
    ...
    & (Affiliates_data["Publication_year"] < 2023)
]
...
# print(Infra_data.info())

Infra_data = Infra_data[
    (Infra_data["Publication_year"] > 2012) & (Infra_data["Publication_year"] < 2023)
]
...
def Citation_graph_func(input, pub_group):
    ...
    if not os.path.isdir("Plots/"):
        os.mkdir("Plots/")
    # fig.show()
    fig.write_image("Plots/{}_Citation_eachyear_since2017.png".format(pub_group))
    fig.write_image("Plots/{}_Citation_eachyear_since2017.svg".format(pub_group))
